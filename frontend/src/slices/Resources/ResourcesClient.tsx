...
interface SlideProps {
    slide: Content.ResourceDocument;
    index: number;
    current: number;
            ...
            >
                ...
                >
                    <h2 className="text-lg md:text-2xl lg:text-4xl font-semibold  relative">
                        <PrismicRichText field={slide.data.title} />
                    </h2>
                    <div className="flex justify-center">
                        <ButtonLink document={slide} className="mt-6  px-4 py-2 w-fit mx-auto sm:text-sm text-black bg-white h-12 border border-transparent text-xs flex justify-center items-center rounded-2xl hover:shadow-lg transition duration-200 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
                            Learn More
                        </ButtonLink>
                    </div>
                </article>
...
interface CarouselProps {
    slides: Content.ResourceDocument[];
}
...
export function Carousel({ slides }: CarouselProps) {
    ...
    return (
        <Bounded className="w-full max-w-[100dvw] overflow-hidden">
